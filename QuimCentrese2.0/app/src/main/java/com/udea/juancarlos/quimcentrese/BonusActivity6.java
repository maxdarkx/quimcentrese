...
public class BonusActivity6 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bonus6);
        Button b=(Button) findViewById(R.id.infoButtonB6);
    ...
    public void popupinfo(View s)
    {
        ...
        infoText.setText(getString(R.string.sB6Points));
