...
public class BonusActivity3 extends AppCompatActivity implements View.OnClickListener {
    PopupWindow pp;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bonus3);
        Button b=(Button) findViewById(R.id.infoButtonB3);
    ...
    public void popupinfo(View s)
    {
        ...
        infoText.setText(getString(R.string.sB3Points));
