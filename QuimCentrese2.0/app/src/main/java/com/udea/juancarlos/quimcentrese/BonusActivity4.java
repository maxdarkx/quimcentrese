...
public class BonusActivity4 extends AppCompatActivity implements View.OnClickListener{
    PopupWindow pp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b=(Button) findViewById(R.id.infoButtonB4);
    ...
    public void popupinfo(View s)
    {
        ...
        infoText.setText(getString(R.string.sB4Points));
    }
