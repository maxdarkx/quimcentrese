...
public class BonusActivity5 extends AppCompatActivity implements View.OnClickListener{
    PopupWindow pp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b=(Button) findViewById(R.id.infoButtonB5);
    ...
    public void popupinfo(View s)
    {
        ...
        infoText.setText(getString(R.string.sB5Points));
    }
